...
declare function preventDefault<S, E extends Event>(action: Dispatchable<S, E>): Action<S, E>;
declare function stopPropagation<S, E extends Event>(action: Dispatchable<S, E>): Action<S, E>;