...
Note that lifecycle events are attached to DOM nodes not to components.  Consider adding a key to ensure that the event is attached to a specific DOM item, rather than a recycled one.
