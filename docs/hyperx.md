...
We'll use [hyperxify](https://github.com/substack/hyperxify) to transform Hyperx into native HyperApp [_h_](/docs/h.md#h) function calls and a bundler to create a single `bundle.js` file we can deliver to the browser.
