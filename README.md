...
_Tip: Lifecycle events are attached to DOM nodes not to components_

_Tip: Consider adding a key to ensure that the event is attached to a specific DOM item, rather than a recycled one._
